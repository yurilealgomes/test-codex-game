# Arcane Survival Asset Requests

These assets are not required for the current placeholder implementation, but they would improve readability and polish in future passes.

| Asset name | Purpose | Priority | Placeholder now? | Notes |
| --- | --- | --- | --- | --- |
| Player wizard model | Replace the primitive low-poly wizard with a authored character model. | High | Yes | Keep a readable silhouette, hat, robe, and staff. |
| Wizard staff model | Improve staff readability and attack direction clarity. | Medium | Yes | Should support a glowing tip. |
| Breakable crystal model | Replace primitive crystal/stone breakables. | High | Yes | Should have low-poly variants and simple color masks. |
| Breakable crate or urn model | Add more world object variety. | Medium | Yes | Must remain easy to identify as breakable. |
...
| Heal pickup icon | Make healing drops instantly readable in combat. | Medium | Yes | Current pickup uses a primitive green cross with a beacon. |
