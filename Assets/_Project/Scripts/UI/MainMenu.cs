...
namespace ArcaneSurvival
{
    public sealed class MainMenu : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            UIFactory.CreateButton(root.transform, "Start Button", "Start Run", new Color(0.16f, 0.34f, 0.48f), StartRun, new Vector2(0.40f, 0.37f), new Vector2(0.60f, 0.46f), Vector2.zero, Vector2.zero);
        }
