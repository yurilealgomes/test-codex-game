...
namespace ArcaneSurvival
{
    public sealed class PauseMenu : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Button resumeButton = UIFactory.CreateButton(root.transform, "Resume Button", "Resume", new Color(0.16f, 0.34f, 0.48f), () => gameManager.ResumeRun(), new Vector2(0.40f, 0.46f), new Vector2(0.60f, 0.54f), Vector2.zero, Vector2.zero);
            Button restartButton = UIFactory.CreateButton(root.transform, "Restart Button", "Restart", new Color(0.32f, 0.18f, 0.28f), () => gameManager.RestartRun(), new Vector2(0.40f, 0.35f), new Vector2(0.60f, 0.43f), Vector2.zero, Vector2.zero);
            root.AddComponent<MenuButtonNavigator>().Configure(new[] { resumeButton, restartButton });
